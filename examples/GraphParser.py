...
def read_arguments():
    ...
    args_.add_argument('--char_embedding', choices=['random','hellwig','morph'], help='Embedding for characters',
                       required=True)
...
def build_model_and_optimizer(args):
    ...
    ###############################################################
    # Freeze the morph taggers
    for name, parameter in model.named_parameters():
        if 'word_lstms_list' in name:
            print('##############################################')
            print('Freezing the morph tagger layers',name)
            print('##############################################')
